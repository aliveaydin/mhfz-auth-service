...
describe("MhfzLoginSession", () => {
  ...
  beforeEach(() => {
    ...
    const LoginSession = proxyquire(
      "../../src/project-session/mhfz-login-session",
      {
        dbLayer: mocks,
        common: {
        ...
        "../../src/project-session/mhfz-session": class {
  ...
  describe("setLoginToRequest", () => {
    it("should set req.session and token correctly", async () => {
      ...
      expect(session.tokenName).to.equal("mhfz-access-token");
    });
